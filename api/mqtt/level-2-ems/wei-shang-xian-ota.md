...
| 参数            | 类型     | 是否必填 | 描述   | 样例                                                                                                                                 |
| ------------- | ------ | ---- | ---- | ---------------------------------------------------------------------------------------------------------------------------------- |
| download\_url | string | 是    | 下载链接 | [http://ali.my.net:6020/example/ems\_device\_backend\_linux\_arm](http://ali.my.net:6020/example/ems\_device\_backend\_linux\_arm) |
...
```json
{
  ...
  "data":{
    "download_url": "http://ali.my.net:6020/example/ems_device_backend_linux_arm64",
